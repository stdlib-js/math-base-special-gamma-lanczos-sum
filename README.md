...
-   [`@stdlib/math/base/special/gamma-lanczos-sum-expg-scaled`][@stdlib/math/base/special/gamma-lanczos-sum-expg-scaled]: calculate a scaled Lanczos sum for the approximation of the gamma function.
